  ...
  try {
    ...
    const product = await db.product.create({
      data: {
        ...
        tags: tags ?? [],
        unit: unit ?? null,
        isMeter: Boolean(isMeter),
        isSquareMeter: Boolean(isSquareMeter),
        requiresWidth: Boolean(requiresWidth),
        requiresHeight: Boolean(requiresHeight),
        features: features ?? null,
        badge: badge ?? null,
        shippingFee: shippingFee == null ? null : Number(shippingFee),
