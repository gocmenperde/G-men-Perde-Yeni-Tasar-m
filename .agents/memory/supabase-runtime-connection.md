...
**How to apply:** Keep explicit `SUPABASE_DATABASE_URL` support in the Prisma client and verify the Vercel environment before removing any legacy catalog fallback.