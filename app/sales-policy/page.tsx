...
export const metadata: Metadata = {
  title: 'sales-policy | Göçmen Kırtasiye',
  alternates: { canonical: SITE_URL + '/sales-policy' },
};
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="relative mt-12 overflow-hidden rounded-[2rem] bg-[#171717] px-6 py-12 text-white shadow-[0_30px_70px_-40px_rgba(23,23,23,0.85)] md:px-14 md:py-16">
          ...
          <div className="relative max-w-2xl">
            ...
            <h1 className="mt-5 text-4xl font-black leading-tight tracking-tight md:text-6xl">Satış Politikası</h1>
            <p className="mt-5 max-w-xl text-base leading-7 text-zinc-400 md:text-lg">Alışveriş deneyiminizin temel ilkeleri</p>
          </div>
        </section>
