...
const STARTER_BANNERS = [
  ...
  {
    title: "Seçili kitaplarda özel fırsatlar",
    subtitle: "Yeni kitaplar ve klasiklerle okuma köşeni yenile.",
    badge: "KİTAP",
    ctaText: "Kitaplara göz at",
    ctaHref: "/products",
    gradient: "rose",
  },
  {
    title: "Masa başını yeniden düzenle",
    subtitle: "Ofis ve çalışma alanın için pratik seçimler.",
    badge: "OFİS",
    ctaText: "Ofis ürünlerini gör",
    ctaHref: "/products",
    gradient: "purple",
  },
  {
