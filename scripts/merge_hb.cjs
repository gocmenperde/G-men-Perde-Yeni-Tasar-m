...
console.log('HB[0]:', JSON.stringify(hbData[0]).substring(0, 400));
console.log('HB[1]:', JSON.stringify(hbData[1]).substring(0, 400));
console.log('Kit[0]:', JSON.stringify(kitData[0]).substring(0, 400));
console.log('Kit[1]:', JSON.stringify(kitData[1]).substring(0, 400));
console.log('Kit[2]:', JSON.stringify(kitData[2]).substring(0, 400));
