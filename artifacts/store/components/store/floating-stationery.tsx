...
import { Pen, Pencil, BookOpen, Ruler, Scissors, Paintbrush, FileText, Star } from "lucide-react";
const items = [
  { Icon: Pen, x: "5%", y: "15%", size: 28, delay: 0, duration: 7, color: "text-amber-400/20" },
  { Icon: Pencil, x: "85%", y: "10%", size: 32, delay: 1.2, duration: 9, color: "text-amber-300/15" },
  { Icon: BookOpen, x: "92%", y: "60%", size: 36, delay: 0.5, duration: 8, color: "text-amber-500/20" },
  ...
  { Icon: Paintbrush, x: "15%", y: "85%", size: 28, delay: 0.8, duration: 11, color: "text-amber-500/15" },
  { Icon: FileText, x: "50%", y: "5%", size: 26, delay: 1.8, duration: 8, color: "text-amber-400/20" },
